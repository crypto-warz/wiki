...
Кроме использования сложной кодовой фразы, о методах создания которой существует [отдельный материал](security/passphrase) от SatoshiLabs, существует еще два метода защиты устройств Trezor:
